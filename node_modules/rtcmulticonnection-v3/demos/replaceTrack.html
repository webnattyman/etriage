...
<head>
    ...
    <title>RTPSender.replaceTrack using RTCMultiConnection</title>

    <meta name="description" content="Replace audio/video tracks in a live conference using RTCMultiConnection" />
...
<body>
    <article>
        ...
        <header style="text-align: center;">
            <h1>RTPSender.replaceTrack using RTCMultiConnection</h1>
            <p>
        ...
        <section class="experiment">
            <div class="make-center">
                ...
                <br><br>
                <button id="replace-video-with-screen">replaceTrack</button>
                <button id="reset-track" disabled>resetTrack</button>
        ...
        <script>
            ...
            connection.socketMessageEvent = 'replaceTrack-demo';
            ...
            document.getElementById('replace-video-with-screen').onclick = function() {
                ...
                document.getElementById('reset-track').disabled = false;
            };
            document.getElementById('reset-track').onclick = function() {
                this.disabled = true;

                // null: means reset-track with all users
                // true: means reset video tracks

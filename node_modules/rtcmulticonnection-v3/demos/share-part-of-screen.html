...
<head>
    ...
    <title>Share Part of Screen using RTCMultiConnection</title>

    <meta name="description" content="Part of Screen Sharing using RTCMultiConnection" />
...
<body>
    <article>
        ...
        <header style="text-align: center;">
            <h1>Share Part of Screen using RTCMultiConnection</h1>
            <p>

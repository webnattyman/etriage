...
<head>
    ...
    <title>Audio+ScreenSharing using RTCMultiConnection</title>
...
<body>
    <article>
        ...
        <header style="text-align: center;">
            <h1>Audio+ScreenSharing using RTCMultiConnection</h1>
            <p>
        ...
        <blockquote>
            Only organizer/initiator shares his screen.<br>
            Screen is one-way; however audio is two-way.<br>
            Organizer can speak with all users.<br>
            All users can NOT only view organizer's screen; but also they can talk with him.<br>

...
<head>
    ...
    <title>MediaStreamTrack.applyConstraints demo using RTCMultiConnection</title>
...
<body>
    <article>
        ...
        <header style="text-align: center;">
            <h1>MediaStreamTrack.applyConstraints demo using RTCMultiConnection</h1>
            <p>
        ...
        <section class="experiment">
            <div class="make-center">
                ...
                <br><br>
                <button id="apply-video-constraints">Apply Constraints</button>
        ...
        <script>
            ...
            connection.socketMessageEvent = 'applyConstraints-demo';
            ...
            document.getElementById('apply-video-constraints').onclick = function() {

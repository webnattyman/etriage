...
<head>
    ...
    <title>addStream in a Chat Room using RTCMultiConnection</title>

    <meta name="description" content="addStream in a Chat Room using RTCMultiConnection" />
...
<body>
    <article>
        ...
        <header style="text-align: center;">
            <h1>addStream in a Chat Room using RTCMultiConnection</h1>
            <p>
        ...
        <section class="experiment">
            <div class="make-center">
                ...
                <button id="btn-addStream" disabled>addStream</button>
                <button id="btn-removeStream" disabled>removeStream</button>
        ...
        <script>
            ...
            document.getElementById('btn-addStream').onclick = function() {
                this.disabled = true;
            ...
            document.getElementById('btn-removeStream').onclick = function() {
                this.disabled = true;
                if(connection.attachStreams.length) {
                    connection.getAllParticipants().forEach(function(p) {
                        connection.attachStreams.forEach(function(stream) {

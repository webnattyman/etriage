...
<head>
    ...
    <title>Disconnect+Rejoin using RTCMultiConnection</title>

    <meta name="description" content="Leave and rejoin same room unlimited times, without reloading the page --- using RTCMultiConnection" />
...
<body>
    <article>
        ...
        <header style="text-align: center;">
            <h1>Disconnect+Rejoin using RTCMultiConnection</h1>
            <p>
        ...
        <section class="experiment">
            <div class="make-center">
                ...
                <br><br>
                <button id="disconnect-room" disabled>Disconnect Room</button>
            <button id="rejoin-room" disabled>Rejoin Room</button>
            </div>

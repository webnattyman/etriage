...
<head>
    ...
    <title>Check if StreamHasData using RTCMultiConnection</title>

    <meta name="description" content="Check if StreamHasData ::: Many-to-Many Video Conferencing using RTCMultiConnection" />
...
<body>
    <article>
        ...
        <header style="text-align: center;">
            <h1>Check if StreamHasData using RTCMultiConnection</h1>
            <p>
        ...
        <blockquote style="text-align:center;">
            Videos will be displayed only if the incoming stream has enough data.
        </blockquote>

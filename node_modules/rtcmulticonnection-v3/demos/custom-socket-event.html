...
<head>
    ...
    <title>Custom+Socket+Event using RTCMultiConnection</title>

    <meta name="description" content="Share private messages among users using Socket.io and RTCMultiConnection" />
...
<body>
    <article>
        ...
        <header style="text-align: center;">
            <h1>Custom+Socket+Event using RTCMultiConnection</h1>
            <p>
        ...
        <script>
            ...
            connection.socketMessageEvent = 'custom-socket-event-demo';

...
<head>
    ...
    <title>TextChat+FileSharing using RTCMultiConnection</title>

    <meta name="description" content="Many-to-Many TextChat and FileSharing using RTCMultiConnection" />
...
<body>
    <article>
        ...
        <header style="text-align: center;">
            <h1>TextChat+FileSharing using RTCMultiConnection</h1>
            <p>
